...
class _C {
  ...
  static const blue     = AppTheme.primaryBlue; // use theme blue
...
class _ProfileScreenState extends State<ProfileScreen>
  ...
  static const double _kExpandedHeight = 440.0;
                            ...
                            Expanded(
                              child: ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                  backgroundColor: destructive ? _C.error : _C.blue,
                  ...
                  slivers: [
                    SliverAppBar(
                      ...
                      title: const Text(
                        'Profile',
                        style: TextStyle(
                            color: _C.white, fontWeight: FontWeight.w600, fontSize: 18),
                    ...
                    SliverPadding(
                      ...
                      sliver: SliverList(
                        delegate: SliverChildListDelegate.fixed([
                          const SizedBox(height: 16), // spacing after app bar
...
Widget _buildHero(Map<String, dynamic> data) {
  ...
  return Container(
    ...
    child: Stack(
      children: [
        ...
        // Content – now with top spacer flex 2, bottom spacer flex 1
        SafeArea(
          bottom: false,
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              const Spacer(flex: 2), // increased top space
              // avatar stack
              Stack(
                children: [
                  Container(
              ...
              Text(
                email,
                style: TextStyle(color: _C.white.withOpacity(0.72), fontSize: 14),
              ),
            ...
            children: [
              ...
              const Align(
                ...
                child: Text(
                  'Help & Support',
                  style: TextStyle(
                      fontSize: 22, fontWeight: FontWeight.w600, color: _C.navy),
                ),
              ),
    ...
    return Container(
      ...
      child: Center(
        child: Text(
          ...
          style: const TextStyle(
              color: _C.white, fontSize: 36, fontWeight: FontWeight.w600),
        ),
      ),
    );
  }
  ...
  Widget _cardTitle(String label, IconData icon) => Row(
        children: [
          Container(
            width: 38,
            height: 38,
          ...
          Text(
            label,
            style: const TextStyle(
                color: _C.navy, fontWeight: FontWeight.w600, fontSize: 17),
          ),
        ],
      );
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  value,
                  style: const TextStyle(
                      fontSize: 15, color: _C.navy, fontWeight: FontWeight.w600),
                ),
              ],
            ),
          ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(sub, style: const TextStyle(fontSize: 12, color: _C.textMid)),
              ],
            ),
          ),
          Switch(
  ...
  Widget _helpItem(IconData icon, String title, String sub) => ListTile(
        ...
        title: Text(
          title,
          style: const TextStyle(
              fontWeight: FontWeight.w600, color: _C.navy, fontSize: 15),
        ),
        subtitle: Text(sub,
