...
// import 'screens/admin/admin_dashboard_navigations.dart';
// import 'screens/admin/admin_attraction_list_screen.dart';
...
// Admin Screens
import 'screens/admin/admin_dashboard_screen.dart'; // DashboardScreen
import 'screens/admin/admin_attraction_list_screen.dart';
import 'screens/admin/admin_attraction_form_screen.dart';
import 'screens/admin/admin_review_list_screen.dart'; 
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => AuthProvider(),
      // Wrap MaterialApp inside a Builder to get correct BuildContext for Provider.of
      child: Builder(
        builder: (context) {
          return MaterialApp(
            title: 'City Guide',
  ...
  Route<dynamic> _generateRoute(RouteSettings settings, BuildContext context) {
    ...
    switch (settings.name) {
      ...
      case AppRoutes.adminAttractions:
        return _adminGuard(authProvider, const AdminAttractionListScreen());
      case AppRoutes.adminAddAttraction:
        return _adminGuard(authProvider, const AdminAttractionFormScreen());
